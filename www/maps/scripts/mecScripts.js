// JavaScript Document
var iconMarker="images/WindGen.png", iconActiveMarker="images/WindGenActive.png", iconCurMarker="images/WindGenCur.png";
function sendForm()
{
	if(marker!=null)
		...
		(
			{
				...
				//dataType: 'json',
				data:{lat:loc.nb, lng:loc.ob, title:$("#title").val(), desc:$("#desc").val(), isActive:$("#isActive").prop("checked"), datefrom:$("#datefrom").val(), dateto:$("#dateto").val(), idpoint:$("#idPoint").val(), fileName:$("#fileName").val(), passwd:$("#passwd").val()},
...
function delPoint()
{
	 $.ajax(
		   ...
		   timeout: 3000,
		    dataType: 'json',
			data: {idpoint:$("#idPoint").val(), fileName:$("#fileName").val(), passwd:$("#passwd").val()},
		    ...
		    if(data['status']=="ok")
			      {
					  data["points"].forEach(function(point)
													  {var pointMarker;
													   ...
													   if(point["active"]=="0")
													      iconName="images/WindGen.png";
														else
														  iconName="images/WindGenActive.png";
